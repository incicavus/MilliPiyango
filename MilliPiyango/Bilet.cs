...
namespace MilliPiyango
{
    class Bilet
    {
        ...
        //BiletNo property si biletNo alanını dış etkilere karşı korur. biletNo sadece bilet çekildiği zaman bilete ait numarayı verir ve kullanıcı ya da sınıfı kullanan diğer yazılımcılar bu alana veri girişi yapamazlar.
